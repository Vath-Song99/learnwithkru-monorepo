          ...
          {dataUser && (
            <div className="flex flex-col items-center justify-center">
              <div className="bg-white flex w-full p-3 items-center rounded-md shadow-sm">
                <div className="flex self-center w-[120px] h-[120px] rounded overflow-hidden">
                  {!previewURL ? (
                    <Image
                ...
                <div className="flex flex-col gap-4 ml-5">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Typography className="ml-1">{dataTutor?.subject}</Typography>
                  </div>
                  <div className="flex gap-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <Typography className="ml-1">{dataTutor?.province}</Typography>
                  </div>
                </div>
              </div>
