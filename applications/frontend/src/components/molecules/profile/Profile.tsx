        ...
        <div  className="flex flex-col justify-start  items-start pl-6">
          ...
          <div className="flex items-center">
            ...
            <Typography
              ...
              variant="normal"
              className="text-gray-500 p-3 text-[10px] "
            >
              {subject}
            </Typography>
          </div>
          <div className=" flex flex-col justify-between   ">
            <div className="flex justify-between items-center w-20">
              ...
              <Typography className="text-gray-500 p-3 text-[10px]" > ${price}</Typography>
            </div>
            <div className="flex justify-between items-center w-20">
              <Typography >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
              ...
              <Typography className="text-gray-500 p-3 text-[10px]" >{phonenumber}</Typography>
            </div>
          </div>
        </div>
      </div>
