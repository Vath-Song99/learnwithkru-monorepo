...
function createConfig(configPath: string) {
  ...
  const requiredConfig = ["NODE_ENV", "PORT", "LOG_LEVEL", "RABBITMQ_ENDPOINT", "CLIENT_URL", "COOKIE_SECRET_KEY_ONE", "COOKIE_SECRET_KEY_TWO", "AUTH_SERVICE_URL", "USER_SERVICE_URL","TEACHER_SERVICE_URL", "STUDENT_SERVICE_URL", "NOTIFICATION_SERVICE_URL"];
